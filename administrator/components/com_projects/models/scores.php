...
class ProjectsModelScores extends ListModel
{
    ...
    public function getItems()
    {
        ...
        foreach ($items as $item)
        {
            ...
            $arr['doPayment'] = (!ProjectsHelper::canDo('core.accountant') && !ProjectsHelper::canDo('core.general')) ? JText::sprintf('COM_PROJECTS_ACTION_TODO_PAYMENT') : JHtml::link(JRoute::_("index.php?option=com_projects&amp;task=payment.add&amp;scoreID={$item->id}&amp;return={$return}"), JText::sprintf('COM_PROJECTS_ACTION_TODO_PAYMENT'));
