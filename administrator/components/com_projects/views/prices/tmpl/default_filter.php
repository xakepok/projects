    ...
    <div class="js-stools-container-bar">
        ...
        <div class="btn-wrapper input-append">
            <input type="text" autocomplete="off" name="filter_search" id="filter_search"
                   ...
                   title aria-label="<?php echo JText::sprintf('COM_PROJECTS_FILTER_PRICE'); ?>"
                   data-original-title="<?php echo JText::sprintf('COM_PROJECTS_FILTER_PRICE'); ?>"
                   placeholder="<?php echo JText::sprintf('COM_PROJECTS_FILTER_PRICE'); ?>"
            >
