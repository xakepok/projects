...
<script type="text/javascript">
    Joomla.submitbutton = function (task) {
        if (task === 'ctritem.cancel' || document.formvalidator.isValid(document.id('adminForm'))) {
    ...
    <div class="row-fluid">
        <div class="span12 form-horizontal">
            ...
            <div class="tab-content">
                <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::sprintf('COM_PROJECTS_BLANK_ITEM_VALUE')); ?>
                <div class="row-fluid">
