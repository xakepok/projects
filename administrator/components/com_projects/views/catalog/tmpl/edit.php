...
$action = JRoute::_('index.php?option=com_projects&amp;view=catalog&amp;layout=edit&amp;id=' . (int)$this->item->id);
...
<script type="text/javascript">
    Joomla.submitbutton = function(task) {
        if (task === 'catalog.cancel' || document.formvalidator.isValid(document.id('adminForm'))) {*/
