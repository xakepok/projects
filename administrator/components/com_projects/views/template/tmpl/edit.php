...
$action = JRoute::_('index.php?option=com_projects&amp;view=template&amp;layout=edit&amp;id=' . (int)$this->item->id);
    ...
    <div class="row-fluid">
        <div class="span12 form-horizontal">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#general" data-toggle="tab"><?php echo JText::sprintf('COM_PROJECTS_BLANK_TEMPLATE');?></a></li>
            </ul>
