...
$return = base64_encode(JUri::base() . "index.php?option=com_projects&view=cattitles");
?>
...
<div id="j-main-container" class="span10 j-toggle-main">
    <form action="<?php echo JRoute::_('index.php?option=com_projects&amp;view=cattitles'); ?>" method="post"
