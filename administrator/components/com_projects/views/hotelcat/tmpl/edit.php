...
$action = JRoute::_('index.php?option=com_projects&amp;view=hotelcat&amp;layout=edit&amp;id=' . (int)$this->item->id);
...
<script type="text/javascript">
    Joomla.submitbutton = function(task) {
        if (task === 'hotelcat.cancel' || document.formvalidator.isValid(document.id('adminForm'))) {*/
    ...
    <div class="row-fluid">
        <div class="span12 form-horizontal">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#general" data-toggle="tab"><?php echo JText::sprintf('COM_PROJECTS_BLANK_HOTEL_CAT');?></a></li>
            </ul>
