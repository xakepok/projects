    ...
    <div class="js-stools-container-bar">
        ...
        <div class="btn-wrapper input-append">
            <input type="text" autocomplete="off" name="filter_search" id="filter_search"
                   ...
                   title aria-label="<?php echo JText::_('COM_PROJECTS_FILTER_EXHIBITOR'); ?>"
                   data-original-title="<?php echo JText::_('COM_PROJECTS_FILTER_EXHIBITOR'); ?>"
                   placeholder="<?php echo JText::_('COM_PROJECTS_FILTER_EXHIBITOR'); ?>"
            >
